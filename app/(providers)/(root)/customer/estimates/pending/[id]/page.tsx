...
} from "@/api/estimates/customerOnly/estimate.api";
  ...
  return (
    <div className="mx-auto w-[327px] md:w-[600px] lg:w-[1400px] flex flex-col lg:flex-row gap-10">
      ...
      <div className="flex-1 flex flex-col gap-y-10">
        <WorkerCardInLiked
          id={estimate.id}
          profileImage={estimate.workerProfileImage}
          nickname={estimate.workerNickname}
          experience={estimate.workerExperience.toString()}
          workerConfirmedEstimatesCount={estimate.workerConfirmedEstimatesCount}
          isFavorite={true}
