...
function WorkerCardInWritableReview({
  ...
  return (
    <div className="flex flex-col justify-between shadow-xs bg-GrayScale-50 border-Line-100 border-[0.5px] rounded-2xl w-[327px] h-[208px] px-3.5 pt-4 pb-2.5 md:w-[600px] lg:w-[688px] lg:h-[362px] lg:gap-8 lg:py-8 lg:px-6">
      <div className="flex gap-2.5 justify-between">
        <ChipMovingType type={serviceType} />
      </div>
      {/* 기사 소개 박스 */}
      <div className="flex justify-between items-center gap-3 shadow-xs bg-GrayScale-50 border-Line-100 rounded-md p-2.5 lg:border-[1px] lg:pr-4 h-[78px] lg:gap-7 lg:h-[144px]">
