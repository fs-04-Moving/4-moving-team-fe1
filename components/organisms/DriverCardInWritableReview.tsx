...
/**
 * DriverCardInWritableReview 컴포넌트
 *
 ...
 *   workerProfileImage="/img/sample.jpg"
 *   workerNickname="김이사"
...
function DriverCardInWritableReview({
  serviceType,
  workerProfileImage,
  workerNickname,
  movingDate,
  ...
  return (
    <div className="flex flex-col justify-between bg-GrayScale-50 border-Line-100 border-[0.5px] rounded-2xl w-[327px] h-[208px] px-3.5 pt-4 pb-2.5 md:w-[600px] lg:w-[688px] lg:h-[362px] lg:h-[202px] lg:gap-8 lg:py-8 lg:px-6">
...
export default DriverCardInWritableReview;
